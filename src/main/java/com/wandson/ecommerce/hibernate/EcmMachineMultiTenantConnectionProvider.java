...
public class EcmMachineMultiTenantConnectionProvider
    ...
    public void injectServices(ServiceRegistryImplementor serviceRegistry) {
        properties = serviceRegistry.getService(ConfigurationService.class).getSettings();
    }
    ...
    private void configurarTenant(String tenant, String url) {
        ...
        props.put("jakarta.persistence.jdbc.password", "flamengo");
        props.put("hibernate.connection.password", "flamengo");
