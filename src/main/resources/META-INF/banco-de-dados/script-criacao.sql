...
alter sequence categoria_SEQ restart with 56;
alter sequence cliente_SEQ restart with 56;
alter sequence estoque_SEQ restart with 56;
alter sequence pedido_SEQ restart with 56;
alter sequence produto_SEQ restart with 56;